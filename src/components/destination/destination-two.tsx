...
import { destinationDataTwo } from '@/data/destination-data';
...
const DestinationTwo = () => {
  ...
  return (
    <div className="it-destination-2-area it-destination-2-pt it-destination-2-overlay p-relative pt-120 pb-120 fix">
      <div className="it-destination-2-shape-box">
        <div className="it-destination-2-shape-1 d-none d-xl-block">
      ...
      <div className="container">
        <div className="row">
          <div className="col-xl-4 col-lg-4">
            <div className="it-destination-2-title-box">
            ...
            <div className="it-destination-2-button">
              <Link href="/about" className="it-btn-secondary">
                Discover More
              </Link>
            </div>
          </div>
          <div className="col-xl-8 col-lg-8">
            <div className="it-destination-2-slider-wrap p-relative">
              <div className="swiper-container it-destination-2-active">
                ...
                >
                  {destinationDataTwo.map((destination) => (
